...
import ru.zadli.ulsu_collaborating.timetable.adapters.RVAdapters.LaunchRVAdapter;
            ...
            Volley.newRequestQueue(this) //Парсим погоду
                    .add(new JsonObjectRequest(GET,
                                    ...
                                    new Response.Listener<JSONObject>() {
                                        ...
                                        public void onResponse(JSONObject response) {
                                            try {
                                                ...
                                                weather_max.setText("На улице: " + current.getString("temp") + "°C" + "  min: " + temp.getString("min") + "°C   max:" + temp.getString("max") + "°C");
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    weather_max.setText("Something seems wrong");
                                }
                            })
                    );
